...
- [@ch402](https://twitter.com/ch402), P = "We can reverse engineer chunks of neural network.", ¬P = "We can't reverse engineer chunks of neural network.", successfully recovered across all methods except for DistilGPT2-based velma.
